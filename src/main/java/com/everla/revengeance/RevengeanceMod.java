package com.everla.revengeance;
...
import com.everla.revengeance.init.RevengeanceModSounds;
...
public class RevengeanceMod {
	public static final Logger LOGGER = LogManager.getLogger(RevengeanceMod.class);
	public static final String MODID = "revengeance";

	public RevengeanceMod(IEventBus modEventBus) {
		...
		RevengeanceModMobEffects.REGISTRY.register(modEventBus);
